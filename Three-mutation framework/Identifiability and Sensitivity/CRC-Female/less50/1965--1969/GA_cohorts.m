...
%Bounds
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
LB=[2E-5 4E-5 0.005 2 8 2 8]; %lower allowed parameter bounds
UB=[5E-5 8E-5 0.015 6 10 6 10];  %upper allowed parameter bounds
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p_pert(3,:) = linspace((1-scale_3)*theta1(3),(1+scale_3)*theta1(3),K);
