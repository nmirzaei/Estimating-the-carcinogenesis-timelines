...
p_pert(3,:) = linspace((1-scale_3)*theta1(3),(3+scale_3)*theta1(3),K);
...
for i=1:length(theta1)
    ...
    box on
    hold on
    plot(p_pert(i,:),numel(data1)*log(smoothdata(profile_likelihoods(i,:)/loss_values,'movmean',7)),'LineWidth',2.5)
