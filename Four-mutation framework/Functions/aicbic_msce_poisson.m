function out = aicbic_msce_poisson(theta, T, Age, yobs, cell_num, N0, bm, varargin)
...
x_ic = [1 0 1 0 1 0 1 0];

[~,Yage] = ode15s(@(t,x) hazardfunc_multi_malignant_cells_SimpleBirth( ...
    t, x, theta, cell_num, N0, bm), tt_plot, x_ic);
