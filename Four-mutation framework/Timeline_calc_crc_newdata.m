...
for k=1:k_lim
    ...
    [tp3,yp3] = ode15s(@(t,x,p) hazardfunc_sub_model_3(t,x,p,N0),0:TT, x_ic3, [], PARAMS(k,:)); 
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %Model (D)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    x_ic4 = [1 0 1 0 1 0 1 -PARAMS(k,4)];
    [tp4,yp4] = ode15s(@(t,x,p) hazardfunc_single_malignant_cells(t,x,p,N0),0:TT, x_ic4, [], PARAMS(k,:));
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    P0_prime_4 = yp4(1:min(T,TT)+1,2).*yp3(1:min(T,TT)+1,1);
    P1_prime_4 = -yp4(1:min(T,TT)+1,4);
    P2_prime_4 = -yp4(1:min(T,TT)+1,6);
    P3_prime_4 = -yp4(1:min(T,TT)+1,8);
    ...
    f_TSMC_given_SSMC = P2_prime_3 / trapz(t_span, P2_prime_3);
    f_TSMC = conv(f_SSMC,f_TSMC_given_SSMC)*dt;
    f_TSMC = f_TSMC(1:length(t_span));
    f_TSMC = f_TSMC/trapz(t_span,f_TSMC);

    f_Malignant_given_TSMC = P3_prime_4 / trapz(t_span, P3_prime_4);
    ...
    E_TSMC(k,1) = trapz(t_span, t_span .* f_TSMC');
